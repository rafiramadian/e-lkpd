...
import { CheckCircle, Eye, EyeOff, Lock, Mail, User, UserPlus } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-sm text-gray-500">Redirecting ke halaman login...</p>
        </motion.div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Buat akun baru untuk mulai belajar</p>
        </div>
